...
public class InterfazAvion extends JFrame {
	 ...
	 * <b>post: </b> Se crea el avi�n y se presenta en una gr�fica su estado
	 * inicial.
	 */
	...
	public void anularPasajero() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Error en el número de cédula.", "Anulación",
		...
		if (!avion.desasignarSilla(pasajero)) {
			JOptionPane.showMessageDialog(this, "El pasajero no tenía silla asignada", "Anulación",
					JOptionPane.ERROR_MESSAGE);
			return;
		}
	...
	public void mostrarPorcentajeOcupacion() {
		...
		df.applyPattern("###.##");
		JOptionPane.showMessageDialog(this, "El porcentaje de ocupación es " + df.format(porcentaje) + "%",
				"Ocupación del avión", JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public void buscarPasajero() {
		...
		if (silla != null) {
			...
			JOptionPane.showMessageDialog(this, "El pasajero no se encuentra registrado", "Búsqueda registro",
	 ...
	 * 
	 * @param componentePadre - Componente padre sobre el que se calcula el centro -
	 *                        componentePadre != null
	 * @param componenteHijo  - Componente hijo que se centra sobre el padre -
	 *                        componenteHijo != null
	...
	public void agregarPelicula(int cedula, String nombre, String genero, int duracion, String director) {
		...
		if (silla != null) {
			...
			JOptionPane.showMessageDialog(this, "La película fue agregada exitosamente.", "Agregar película",
					JOptionPane.INFORMATION_MESSAGE);
		} else {
			JOptionPane.showMessageDialog(this, "No existe pasajero con la cédula dada", "Buscar películas",
					JOptionPane.INFORMATION_MESSAGE);
		}
	}
	...
	public void buscarPeliculas() {
		String cedula = JOptionPane.showInputDialog(this, "Ingrese la cédula del pasajero:", "Cédula pasajero",
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Debe ingresar un valor válido para la cédula.", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	/**
	 * Muestra el di�logo que da todas las pel�culas de un g�nero para un pasajero
	 * determinado.
	 */
	...
	/**
	 * Muestra en un di�logo las pel�culas que pertenecen a un determiando g�nero y
	 * son de alg�n pasajero determinado por par�metro.
	 * 
	...
	public void peliculasGenero(int cedula, String genero) {
		...
		if (silla != null) {
			...
			JOptionPane.showMessageDialog(this, "No existe un pasajero con esa cédula.", "Error",
					JOptionPane.ERROR_MESSAGE);
	...
	/**
	 * Determina si un pasajero espec�fico tiene dos pel�culas con la misma
	 * duraci�n.
	 */
	public void peliculasMismaDuracion() {
		...
		try {
			...
			if (silla != null) {
				...
				JOptionPane.showMessageDialog(this, rta, "Películas de misma duración",
						JOptionPane.INFORMATION_MESSAGE);
